...
export const TeacherUpdate = () => {
  ...
  const [updateTeacher, { isSuccess: isTeacherUpdateSuccess, isError: isTeacherUpdateError }] = useUpdateTeacherMutation();
  ...
  console.log(typeof dayjs(new Date()).format('YYYY-MM-DD'));
  ...
  const handleSubmit = async (e) => {
    ...
    console.log('&&&&',dayjs(teacherData.birthday).toDate());
  ...
  useEffect(() => {
    console.log('useEffect', teacherById);
    console.log('teacherById', teacherById);
    ...
    console.log('***', teacherById?.birthday);
    console.log('*** dayjs', birthdayValue);
  }, [teacherById])
  console.log('teach', teacherData);
  console.log('workingGraphic state', teacherData?.workingGraphic);
  return (
